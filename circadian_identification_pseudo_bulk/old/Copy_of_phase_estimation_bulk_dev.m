...
for icell_type = 1:ncell_types
    ...
    my_val = zscore(log(T1.MAE+1));
    pd_mae = fitdist(my_val,'Normal'); % Lognormal looks better but don't understand it
