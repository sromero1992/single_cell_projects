# ============================================================================
# TimeSCape v0.2  --  Multi-Cell-Type Analysis Script  [Advanced stage]
#
...
out_dir   <- file.path(base_dir, "TimeSCape_output_advanced")
...
data <- readRDS(file.path(base_dir,
                          "circadian_mouse_breast_decontX_QC_2_23_2026_subann_advanced.rds"))
